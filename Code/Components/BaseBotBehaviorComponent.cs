...
public interface IBotBehavior
{
	...
	/// </summary>
	void Initialize( BotPlayerControllerComponent controller );
...
/// </summary>
public abstract class BaseBotBehaviorComponent : Component, IBotBehavior
{
	protected BotPlayerControllerComponent Controller { get; private set; }
	protected PlayerPawnComponent Player => Controller.Player;
	protected NavMeshAgent MeshAgent => Controller.MeshAgent;

	public virtual int Priority => 0;

	void IBotBehavior.Initialize( BotPlayerControllerComponent controller )
	{
