...
namespace Sandbox.Components.GlobalComponents;

/// <summary>
/// A list of globals that are relevant to the player. Health, armor, VFX that we don't want to hardcode somewhere.
/// </summary>
public class PlayerGlobalsGlobalComponent : GlobalComponent, IGameEventHandler<ModifyDamageGlobalEvent>
{
	...
	void IGameEventHandler<ModifyDamageGlobalEvent>.OnGameEvent( ModifyDamageGlobalEvent eventArgs )
	{
		...
		var resource = (eventArgs.DamageInfo.Inflictor as EquipmentComponent)?.Resource;
