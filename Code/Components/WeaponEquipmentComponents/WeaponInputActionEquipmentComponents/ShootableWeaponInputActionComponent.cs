	...
	IGameEventHandler<EquipmentHolsteredEvent>
{
	...
	/// </summary>
	[Property, Category( "Ammo" ), Feature( "Ammo" )] public WeaponAmmoComponent AmmoComponent { get; set; }
	...
	/// </summary>
	protected WeaponModelComponent Effector
	{
		get
		{
			...
			return Equipment.ViewWeaponModel;
		}
	}
	...
	public void CycleFireMode()
	{
		...
		Equipment.ViewWeaponModel?.OnFireMode( CurrentFireMode );
