...
public abstract class BaseGrenadeComponent : Component
{
	...
	[Sync] public PlayerPawnComponent Player { get; set; }

	/// <summary>
	/// Is this player an enemy of the viewer?
	/// </summary>
	public bool IsEnemy => ClientComponent.Viewer.Team != Player.Team;
