...
/// </summary>
public abstract class WeaponInputActionEquipmentComponent : WeaponEquipmentComponent,
	IGameEventHandler<EquipmentDeployedEvent>
{
	...
	/// </summary>
	[Property, Category( "Base" )] public Action<WeaponInputActionEquipmentComponent> OnInputAction { get; set; }
