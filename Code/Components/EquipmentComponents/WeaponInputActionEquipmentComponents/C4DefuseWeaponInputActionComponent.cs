...
public partial class C4DefuseWeaponInputActionEquipmentComponent : WeaponInputActionEquipmentComponent, 
	IGameEventHandler<EquipmentHolsteredEvent>
{
	...
	private BombSiteComponent CurrentBombSite => Equipment.IsValid() && Equipment.Owner.IsValid() ? Equipment.Owner.GetZone<BombSiteComponent>() : null;
	...
	private void StartPlant()
	{
		...
		{
			RadioSoundsGameResource.Play( Equipment.Owner.Team, "Hidden", "Planting bomb" );
		}
