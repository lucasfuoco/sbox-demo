...
public partial class PlayerPawnComponent
{
	...
	/// </summary>
	[RequireComponent] public PlayerInventoryComponent Inventory { get; private set; }
	...
	private void CreateRagdoll()
	{
		...
		{
			var comp = Body.Components.Create<DestroyAfterComponent>();
			comp.Time = ev.DestroyTime;
		}
		else
		{
			Body.Components.Create<DestroyBetweenRoundsComponent>();
		}
	...
	private void ResetBody()
	{
		...
		foreach ( var outfitter in GetComponentsInChildren<HumanOutfitterComponent>( true ) )
		{
