...
public sealed partial class PlayerPawnComponent : PawnComponent, IDescription, IAreaDamageReceiverValid
{
	/// <summary>
	/// The player's body
	/// </summary>
	...
	/// </summary>
	[RequireComponent] public CameraControllerComponent CameraController { get; set; }
	...
	/// </summary>
	[RequireComponent] public SpotterComponent Spotter { get; set; }

	/// <summary>
	/// The spottable for this player.
	/// </summary>
	[RequireComponent] public SpottableComponent Spottable { get; set; }
	...
	// IAreaDamageReceiver
	void IAreaDamageReceiverValid.ApplyAreaDamage( AreaDamageComponent component )
	{
	...
	void UpdatePlayArea()
	{
		...
		if ( Scene.GetSystem<PlayAreaSystemGameObjectSystem>().Count < 1 )
			return;

		var playArea = GetZone<PlayerAreaComponent>();
		if ( !playArea.IsValid() )
		{
			if ( InPlayArea )
			{
