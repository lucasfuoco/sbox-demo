...
public partial class DronePawnComponent : PawnComponent, IRespawnable, ICustomMinimapIconValid
{
	...
	[RequireComponent] public DroneSoundsComponent DroneSounds { get; set; }
	[RequireComponent] public PawnCameraControllerComponent CameraController { get; set; }
	...
	/// What are we called?
	/// </summary>
	public override string DisplayName => Client.IsValid() ? $"{Client.DisplayName}'s drone" : "Drone";
	...
	string ICustomMinimapIconValid.CustomStyle => $"background-image-tint: {Team.GetColor().Hex}";
	string IMinimapIconValid.IconPath => "ui/icons/drone.png";
