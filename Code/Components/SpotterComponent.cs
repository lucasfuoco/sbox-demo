...
/// </summary>
public sealed class SpotterComponent : Component
{
	public static float Interval = 0.5f;

	[Property] PlayerPawnComponent Player { get; set; }
	...
	protected override void OnUpdate()
	{
		...
		foreach ( var spottable in Scene.GetAllComponents<SpottableComponent>() )
		{
	...
	private void Poll( SpottableComponent spottable )
	{
