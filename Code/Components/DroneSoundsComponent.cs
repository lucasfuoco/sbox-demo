...
public partial class DroneSoundsComponent : Component
{
	[Property] public DronePawnComponent Drone { get; set; }
	...
	void Play()
	{
		if ( !Drone.IsValid() || !Drone.Rigidbody.IsValid() || DroneSound is null )
			return;
