...
using static Sandbox.Components.SingletonComponents.GameModeSingletonComponent;
...
/// </summary>
public sealed class TeamScoringComponent : Component,
	...
	IGameEventHandler<TeamsSwappedEvent>
{
	...
	public int MyTeamScore => Scores.GetValueOrDefault( ClientComponent.Local.Team );
	public int OpposingTeamScore => Scores.GetValueOrDefault( ClientComponent.Local.Team.GetOpponents() );
	...
	IGameEventHandler<UpdateStateEvent>
{
	...
	{
		var teamScoring = GameModeSingletonComponent.Instance.Get<TeamScoringComponent>( true );
