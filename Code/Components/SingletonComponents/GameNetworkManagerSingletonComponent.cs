...
/// </summary>
public sealed class GameNetworkManagerSingletonComponent : SingletonComponent<GameNetworkManagerSingletonComponent>, Component.INetworkListener
{
	/// <summary>
	...
	/// <returns></returns>
	private ClientComponent GetOrCreateClient( Connection channel = null )
	{
		var Clients = Scene.GetAllComponents<ClientComponent>();
	...
	void INetworkListener.OnDisconnected( Connection channel )
	{
		...
		var cl = Scene.GetAllComponents<ClientComponent>().FirstOrDefault( x => x.Connection == channel );
	...
	public void OnPlayerJoined( ClientComponent Client, Connection channel )
	{
