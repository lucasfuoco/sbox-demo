...
partial class GameModeSingletonComponent
{
	...
	public string DisplayedStatus => TeamStatusText.GetValueOrDefault( ClientComponent.Local.Team );
	...
	{
		ToastPanel.Instance?.Show( value, type, duration );
	}

	[Rpc.Broadcast( NetFlags.HostOnly )]
	public void HideToast()
	{
		ToastPanel.Instance?.Show( "", ToastType.Generic, 0f );
	}
}
