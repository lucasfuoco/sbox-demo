...
/// The bot for players
/// </summary>
public class BotPlayerControllerComponent : Component, IBotController
{
	[Property]
	public NavMeshAgent MeshAgent { get; set; }

	public PlayerPawnComponent Player { get; set; }



	protected override void OnAwake()
	{
		Player = GetComponentInParent<PlayerPawnComponent>( true );
	...
	internal void UpdateBehaviors()
	{
		...
		if ( _timeSincePerception > _perceptionInterval )
		{
			...
			var perceptionNode = new UpdatePerceptionNodeBehaviorNode();
	...
	void IBotController.OnControl( BotControllerComponent bot )
	{
