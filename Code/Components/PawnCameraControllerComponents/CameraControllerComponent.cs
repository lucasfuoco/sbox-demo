...
public sealed class CameraControllerComponent : PawnCameraControllerComponent, IGameEventHandler<DamageTakenEvent>
{
	...
	{
		var pl = ClientComponent.Local.PlayerPawn;
	...
	private void ApplyScope()
	{
		...
		if ( Player.CurrentEquipment.GetComponentInChildren<FlatScopeWeaponActionEquipmentComponent>() is { } scope )
		{
	...
	void ApplyRecoil()
	{
		...
		if ( Player.CurrentEquipment.GetComponentInChildren<ShootRecoilEquipmentComponent>( true ) is { } fn )
