...
[Title( "Area Damage" )]
public class AreaDamageComponent : Component, Component.ITriggerListener
{
	...
	{
		public IAreaDamageReceiverValid Receiver { get; init; }
	...
	/// <summary>
	/// Ignore any <see cref="IAreaDamageReceiverValid"/> targets with any of these tags.
	/// </summary>
	...
	void ITriggerListener.OnTriggerEnter( Collider other )
	{
		...
		var receiver = other.GameObject?.Root.GetComponentInChildren<IAreaDamageReceiverValid>();
