...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("weap_mike9a3_sup_plr")
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
            Outside = {
...
SWEP.Customization = {
    ...
    {"attachment_vm_pi_mike9_mag", "attachment_vm_pi_mike9_xmags", "attachment_vm_pi_mike9_xmagslrg"},
    
    {"attachment_vm_pi_mike9_pgrip",
