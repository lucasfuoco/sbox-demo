...
SWEP.Trigger = {
    PressedSound = Sound("weap_mike9a3_fire_first"),
    ReleasedSound = Sound("weap_mike9a3_fire_disconnector"),
    Time = 0
}
SWEP.Slot = 1
...
SWEP.ParticleEffects = {
    ["MuzzleFlash"] = "mwb_muzzle_pl_1",
    ["MuzzleFlash_Suppressed"] = "mwb_suppressor_0",
    ["Ejection"] = "mwb_shell_eject", 
}


SWEP.Primary.Sound = Sound("weap_mike9a3_fire_plr")
...
SWEP.Recoil = {
    Vertical = {0.05, 0.2}, --random value between the 2
