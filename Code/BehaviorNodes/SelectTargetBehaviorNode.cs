...
/// </summary>
public class SelectTargetBehaviorNode : BaseBehaviorNode
{
	...
	protected override NodeResult OnEvaluate( BotContext context )
	{
		...
		var enemies = context.GetData<List<PawnComponent>>( ENEMIES_KEY );
	...
	private float GetTargetScore( PawnComponent target, Ray aimRay )
	{
