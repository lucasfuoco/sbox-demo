...
/// </summary>
public class AimAtTargetBehaviorNode : BaseBehaviorNode
{
	private const string CURRENT_TARGET_KEY = "current_target";

	private PawnComponent _currentTarget;
	private PlayerPawnComponent _currentPlayer;
	...
	protected override NodeResult OnEvaluate( BotContext context )
	{
		...
		if ( _currentTarget != target )
		{
			...
			if ( _currentTarget is PlayerPawnComponent player )
			{
