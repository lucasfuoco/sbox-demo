...
internal static class Stats
{
	...
	{
		if ( gameModeBased && !string.IsNullOrEmpty( GameModeSingletonComponent.Instance.Ident ) )
		{
			var gameModeName = System.IO.Path.GetFileNameWithoutExtension( GameModeSingletonComponent.Instance.Ident );
